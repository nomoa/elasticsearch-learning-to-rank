...
import com.o19s.es.ltr.ranker.PrebuiltFeature;
import com.o19s.es.ltr.ranker.RankerQuery;
...
public class LtrQueryTests extends LuceneTestCase {
    ...
    public void checkModelWithFeatures(List<PrebuiltFeature> features) throws IOException {
        ...
        RankerQuery ltrQuery = RankerQuery.build(new RanklibRanker(ranker), features.toArray(new PrebuiltFeature[features.size()]));
        ...
        ltrQuery = RankerQuery.build(new RanklibRanker(rankerAgain), features.toArray(new PrebuiltFeature[features.size()]));
