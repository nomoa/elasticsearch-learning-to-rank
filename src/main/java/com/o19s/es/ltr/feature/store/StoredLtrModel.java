...
public class StoredLtrModel implements LtrModel, Accountable {
    ...
    static {
        PARSER = new ObjectParser<>("ltr_model");
    ...
    private StoredLtrModel(String name, StoredFeatureSet featureSet, LtrRanker ranker) {
        this.name = name;
    ...
    private static class ParsingState {
        ...
        public void setFeatureSet(StoredFeatureSet featureSet) {
            this.featureSet = featureSet;
        }

        public void setRankingModel(LtrModelDefinition rankingModel) {
    ...
    private static class LtrModelDefinition {
        ...
        static {
            PARSER = new ConstructingObjectParser<LtrModelDefinition, Void>("model",
